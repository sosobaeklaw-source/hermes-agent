...
판결문 3건이 **46개 atom**으로 분해됐고, atom 간 + 파이프라인 산출물에서 atom으로의 wikilink는
**177개** 형성됨 (자동 검증 스크립트로 측정). 평균 in-degree 3.57, out-degree 3.20.
이 그래프 자체가 "LLM이 대법원처럼 사고하도록" 훈련시키는 base graph가 됨.
